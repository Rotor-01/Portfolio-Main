...
const SkillBadge = ({ name, delay = 0 }: SkillBadgeProps) => {
  return (
    ...
    >
      ...
      <div className="relative bg-card border border-black px-4 py-2 flex items-center justify-center transition-transform group-hover:-translate-y-0.5 group-hover:-translate-x-0.5">
